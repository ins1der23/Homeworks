...
public class UiTextRus implements iUiText {
    ...
    public UiTextRus() {
        mainMenu = new String[] { "Загрузить список игрушек для розыгрыша из файла",
                ...
                "Добавить игрушку",
                "Разыграть игрушки",
                "Посмотерть результаты розыгрыша / список призов для выдачи",
                "Выдать призы",
                "Выход" };
        ...
        participants = "Введите количество участников (от 1 до 100)";
        pause = "Нажмите ENTER для продолжения";
        prizeCount = "Введите число призов для выдачи (от 1 до 20)";
    }
